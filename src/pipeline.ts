    ...
    for (let i = 0; i < count; i++) {
      ...
      switch (g.type) {
        ...
        case 'procedural-hit-group':
          // Allow sentinel 0xff meaning no intersection shader (analytic procedural geometry)
          if (g.intersectionIndex !== WEBRTX_SHADER_UNUSED) {
            ...
            intersect = WEBRTX_SHADER_UNUSED;
          }
          // fall through so we still pack ahit/chit bits below
        // fall through
